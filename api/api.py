        ...
        if os.path.exists(bookpath):
            if os.path.isdir(bookpath):
                ...
                try:
                    ...
                    #弹出文件夹选择框
                    file_path =  System.window.create_file_dialog(webview.SAVE_DIALOG, directory=bookpath, file_types=("Text files (*.txt)",), save_filename=bookdata[2]+'.txt')
        ...
        if os.path.exists(bookpath):
            if os.path.isdir(bookpath):
                ...
                try:
                    ...
                    #弹出文件夹选择框
                    file_path =  System.window.create_file_dialog(webview.SAVE_DIALOG, directory=bookpath, file_types=("Epub files (*.epub)",), save_filename=bookdata[2]+'.epub')
